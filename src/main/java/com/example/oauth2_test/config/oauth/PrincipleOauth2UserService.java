...
public class PrincipleOauth2UserService extends DefaultOAuth2UserService {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        System.out.println("getTokenValue ==> " + userRequest.getAccessToken().getTokenValue()); //엑세스 토큰
        ...
        System.out.println("getAttributes ==>" + oAuth2User.getAttributes()); //해당 내용으로 가입을 시킴
...
//        String email = oAuth2User.getAttribute("email");
        ...
        // OAuth2 가입 정보로 User정보 조회후 저장
        User userEntity = userRepository.findByUsername(username);
        if (userEntity == null) {
            userEntity = User.builder() //User의 @Builder에 의해 작동
                    .username(username)
        ...
        return new PrincipalDetails(userEntity, oAuth2User.getAttributes()); //이친구가 Authentication객체로 들어간다.
